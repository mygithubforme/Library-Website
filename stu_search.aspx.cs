...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<table cellpadding='10px' style='font-family:calibri;color:white;z-index:10;text-align:center;border:3px solid gray;position:absolute;top:430px;left:480px'> <tr> <th>Book Name </th><th> Rack No</th><th>Available Book</th><th>Total Book</th></tr><tr><td>" + bname + "</td><td>" + rack + "</td><td>" + count + "</td><td>" + totalbook + "</td></tr></table>");
