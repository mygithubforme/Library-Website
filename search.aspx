<%@ Page Title="Search" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="Default2" %>
...
<div style=" opacity:0.9;  width:625px; height:495px; position:absolute;  top:149px; left:362px; background-image: url('Images/sea.png'); background-size:100% 100%; background-repeat: no-repeat;">
  ...
  <div id="before" runat="server" style="position:absolute; top:270px; left:95px" >

    <table style="width:100%; text-align :center" >
        <tr>
            <td>
                <asp:TextBox ID="txtSearch" placeholder="Search here....!!" runat="server" Width="400px" 
                    class="span2 search-query" Height="24px"  
                    ></asp:TextBox>
                ...
                <br/><br/>
                <asp:Button ID="Button1" class="btn btn-info" runat="server" Text="Serach" 
                    Font-Names="Calibri" ForeColor="White" Font-Size="Large" 
