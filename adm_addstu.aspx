<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="adm_addstu.aspx.cs" Inherits="_Default" %>
...
<table style="text-align:left;font-weight: normal; font-size: large; font-family: Calibri;">
          <tr>
                <td>
                    Name:
                </td>   
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox  class="input-medium" placeholder="e.g. 100010107011" 
                        ID="enrollTxt" runat="server"></asp:TextBox>
                     
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="enrollTxt" ErrorMessage="Required" 
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" validationexpression="^[0-9]{12}$"
                        CssClass="validator" ControlToValidate="enrollTxt" 
                ...
                <td>
                   <asp:TextBox  class="input-medium" placeholder="Exclude +91" ID="contactTxt" 
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        validationexpression="^[0-9]{10}$" CssClass="validator"
                        ErrorMessage="Not Valid" ControlToValidate="contactTxt"></asp:RegularExpressionValidator>
